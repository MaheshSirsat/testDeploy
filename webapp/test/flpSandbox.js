		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Titledemo",
									"targetURL": "#comportfoliodemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comportfoliodemo-display": {
								"semanticObject": "comportfoliodemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.portfolio.demo",
									"url": sap.ui.require.toUrl("com/portfolio/demo")
								}
							}
						}
					}
